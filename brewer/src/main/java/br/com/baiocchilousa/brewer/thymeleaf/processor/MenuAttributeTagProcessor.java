...
public class MenuAttributeTagProcessor extends AbstractAttributeTagProcessor{
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName name,
		...
		//Pega o valor passado como atributo da tag interpretando o contexto completo (@{})
		...
		if(uri.startsWith(menu)) {//Se a URI começa com o que está descrito na propriedade 'menu'
