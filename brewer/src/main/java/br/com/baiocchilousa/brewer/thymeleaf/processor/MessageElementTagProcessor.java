...
/**
 * Classe que extende o Thymeleaf e cria uma tag nova brewer:message
 * 
 *
 */
...
public class MessageElementTagProcessor extends AbstractElementTagProcessor{
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		structureHandler.replaceWith(model, true);//Ainda é necessário que o Thymeleaf trabalhe (por isso o true)
	}
